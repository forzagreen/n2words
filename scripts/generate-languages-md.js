...
// Option names, types, descriptions and defaults are extracted by
// ./lib/options-index.js — shared with the GitHub Pages manifest generator so
// the docs table and the demo's options panel render the same data.

/** @typedef {import('./lib/options-index.js').OptionInfo} OptionInfo */
