...
import { fil as CURRENCY_VOCAB, assertCurrencyExponent } from './utils/currency-vocab.js'
 ...
 * @property {import('./utils/currency-vocab.js').FilCurrency} [currency] - ISO 4217 currency code to name the amount in
 */
