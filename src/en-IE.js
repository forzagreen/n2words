/**
 * English (Ireland) currency profile of en-GB
 *
 ...
 * country" (Ireland) are different axes, and only the latter varies
 * here. Only the default currency differs (EUR, not en-GB's
 * default).
 */
...
/**
 * Converts a numeric value to Irish English currency words. Delegates
 ...
 * @example
 * toCurrency(42.50)                    // 'forty-two euro and fifty cent'
 */
