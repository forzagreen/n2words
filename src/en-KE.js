...
import { enKE as CURRENCY_VOCAB, assertCurrencyExponent } from './utils/currency-vocab.js'
...
function toCurrency(value, options) {
  ...
  if (shillings > 0n || cents === 0n) {
    result += integerToWords(shillings)
    result += ' ' + (shillings === 1n ? major[0] : major[1])
  }
