/**
 * English (New Zealand) currency profile of en-GB
 *
 ...
 * country" (New Zealand) are different axes, and only the latter varies
 * here. Only the default currency differs (NZD, not en-GB's
 * default).
 */
...
// eslint-disable-next-line import-x/export -- deliberate shadow, see comment above
export const currencyDefaults = { and: true, currency: 'NZD' }

/**
 * Converts a numeric value to New Zealand English currency words. Delegates
