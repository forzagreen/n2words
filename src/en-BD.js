/**
 * English (Bangladesh) currency profile of en-IN
 *
 ...
 * country" (Bangladesh) are different axes, and only the latter varies
 * here. Only the default currency differs (BDT, not en-IN's
 * default).
 */
...
// eslint-disable-next-line import-x/export -- deliberate shadow, see comment above
export const currencyDefaults = { and: true, currency: 'BDT' }

/**
 * Converts a numeric value to Bangladeshi English currency words. Delegates
 ...
 * @example
 * toCurrency(42.50)                    // 'forty-two taka and fifty paisa'
 */
