/**
 * English (Nigeria) currency profile of en-GB
 *
 ...
 * country" (Nigeria) are different axes, and only the latter varies
 * here. Only the default currency differs (NGN, not en-GB's
 * default).
 */
...
/**
 * Converts a numeric value to Nigerian English currency words. Delegates
