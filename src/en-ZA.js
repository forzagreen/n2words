/**
 * English (South Africa) currency profile of en-GB
 *
 ...
 * country" (South Africa) are different axes, and only the latter varies
 * here. Only the default currency differs (ZAR, not en-GB's
 * default).
 */
...
// eslint-disable-next-line import-x/export -- deliberate shadow, see comment above
export const currencyDefaults = { and: true, currency: 'ZAR' }

/**
 * Converts a numeric value to South African English currency words. Delegates
