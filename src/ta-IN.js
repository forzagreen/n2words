...
import { ta as CURRENCY_VOCAB, assertCurrencyExponent } from './utils/currency-vocab.js'
 ...
 * @property {import('./utils/currency-vocab.js').TaCurrency} [currency] - ISO 4217 currency code to name the amount in
 */
...
function toCurrency(value, options) {
  ...
  if (rupees > 0n || paise === 0n) {
    result += integerToWords(rupees) + ' ' + major[0]
  }
