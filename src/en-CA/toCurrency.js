/**
 * Canadian English currency.
 *
 * CLDR: en-CA | English as used in Canada
 *
 * CAD is baked in as the default because en-CA names one country. Any
 ...
 * default carries only CAD's words.
 */
...
import { CAD } from '../lib/en/currencies.js'
 ...
 * @property {import('../utils/check-currency.js').CurrencyVocab} [currency] - Currency vocabulary; defaults to CAD
 */
 ...
 * @example
 * import { toCurrency, JPY } from 'n2words/en-CA/toCurrency'
