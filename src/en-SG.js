/**
 * English (Singapore) currency profile of en-GB
 *
 ...
 * country" (Singapore) are different axes, and only the latter varies
 * here. Only the default currency differs (SGD, not en-GB's
 * default).
 */
...
/**
 * Converts a numeric value to Singaporean English currency words. Delegates
