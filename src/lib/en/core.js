/**
 * American English number-word internals.
 *
 * Private to this directory: shared by en-US's three form modules and by
 * nothing else. Not a cross-language library — every language owns its own,
 * so changing en-US never reaches another language.
 */
...
export { SCALES, ONES, TENS, HUNDRED, ZERO, NEGATIVE, DECIMAL_SEP, buildSegment, integerToWords, decimalPartToWords }
