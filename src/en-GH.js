/**
 * English (Ghana) currency profile of en-GB
 *
 ...
 * country" (Ghana) are different axes, and only the latter varies
 * here. Only the default currency differs (GHS, not en-GB's
 * default).
 */
...
/**
 * Converts a numeric value to Ghanaian English currency words. Delegates
 ...
 * @example
 * toCurrency(42.50)                    // 'forty-two cedis and fifty pesewas'
 */
