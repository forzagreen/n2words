...
import { lv as CURRENCY_VOCAB, assertCurrencyExponent } from './utils/currency-vocab.js'
 ...
 * @property {import('./utils/currency-vocab.js').LvCurrency} [currency] - ISO 4217 currency code to name the amount in
 */
...
function toCurrency(value, options) {
  ...
  // Every lv entry sets both gender fields (currency-vocab-contract.test.js
  ...
  // Euro part (eiro is indeclinable, hence the single major form). Gender
  // still drives the numeral itself — see docs/currency-vocab.md.
