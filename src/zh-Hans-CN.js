...
import { zhHans as CURRENCY_VOCAB, assertCurrencyExponent } from './utils/currency-vocab.js'
 ...
 * @property {boolean} [formal] - Use formal/financial numerals
 * @property {import('./utils/currency-vocab.js').ZhHansCurrency} [currency] - ISO 4217 currency code to name the amount in
 */
