/**
 * English (Australia) currency profile of en-GB
 *
 ...
 * country" (Australia) are different axes, and only the latter varies
 * here. Only the default currency differs (AUD, not en-GB's
 * default).
 */
...
/**
 * Converts a numeric value to Australian English currency words. Delegates
