/**
 * English (the Philippines) currency profile of en-GB
 *
 ...
 * country" (the Philippines) are different axes, and only the latter varies
 * here. Only the default currency differs (PHP, not en-GB's
 * default).
 */
...
// eslint-disable-next-line import-x/export -- deliberate shadow, see comment above
export const currencyDefaults = { and: true, currency: 'PHP' }

/**
 * Converts a numeric value to Philippine English currency words. Delegates
 ...
 * @example
 * toCurrency(42.50)                    // 'forty-two pesos and fifty centavos'
 */
