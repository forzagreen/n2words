...
} as N2WordsOptions & { withHyphenSeparator?: boolean })
...
const customNegative: string = n2words(-100, {
  lang: 'ar',
  negativeWord: 'سالب'
} as N2WordsOptions & { negativeWord?: string })
console.log(customNegative) // 'سالب مائة'

// Type-safe function wrapper
function convertNumber(value: number | string | bigint, language: string = 'en'): string {
...
const supportedLanguages = [
  'en', 'ar', 'az', 'cz', 'de', 'dk', 'es', 'fa', 'fr', 'fr-BE',
  'he', 'hr', 'hu', 'id', 'it', 'ko', 'lt', 'lv', 'nl', 'no',
  'pl', 'pt', 'ro', 'ru', 'sr', 'tr', 'uk', 'vi', 'zh'
]
