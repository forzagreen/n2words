...
/**
 * Converts a number to Hindi cardinal (written) form.
 *
 * @param {number|string|bigint} value The number to convert.
 * @param {HindiOptions} [options={}] Configuration options.
 * @returns {string} The number expressed in Hindi words.
 * @throws {TypeError} If value is an invalid type.
 * @throws {Error} If value is NaN or an invalid number string.
 * @example
 * convertToWords(123456); // 'एक लाख तेईस हज़ार चार सौ छप्पन'
 * convertToWords(1234567); // 'बारह लाख चौंतीस हज़ार पाँच सौ सड़सठ'
 */
