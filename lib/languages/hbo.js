...
export class BiblicalHebrew extends SlavicLanguage {
   ...
   */
  constructor ({ and = 'ו', feminine = false } = {}) {
    super({ feminine })
...
/**
 * Converts a number to Biblical Hebrew cardinal (written) form.
 *
 * @param {number|string|bigint} value The number to convert.
 * @param {BiblicalHebrewOptions} [options={}] Configuration options.
 * @returns {string} The number expressed in Biblical Hebrew words.
 * @throws {TypeError} If value is an invalid type.
 * @throws {Error} If value is NaN or an invalid number string.
 */
export default function convertToWords (value, options = {}) {
  return new BiblicalHebrew(options).convertToWords(value)
}
