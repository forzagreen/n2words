...
export class Filipino extends GreedyScaleLanguage {
  ...
  /** Converts whole number with explicit zero handling. */
  integerToWords (wholeNumber) {
    // Handle zero explicitly
    if (wholeNumber === 0n) {
      return this.zeroWord
    }
    return super.integerToWords(wholeNumber)
  }

  /** Merges scale components with Filipino connector and linker rules. */
