...
/**
 * Filipino language converter for n2words.
 *
 * Converts numbers to words in Filipino (Tagalog), supporting scale-based conversion,
 * digit-by-digit decimals, and Filipino-specific grammar rules for connectors and omission.
 *
...
export class Filipino extends GreedyScaleLanguage {
   ...
   * - Uses "ng" as a connector between words, except for consonant-ending words, which use "na".
   * - Omits the word for "one" when followed by a value < 100 (e.g., "isang daan" → "daan").
   * - Special linker for certain tens (e.g., "limampu" + ones).
   * - Does not merge zero with any other value.
   *
