...
/**
 * Chinese Simplified language converter.
 *
 * Features:
 ...
 */
export class ChineseSimplified extends GreedyScaleLanguage {
  negativeWord = '负'
   ...
   *
   * @param {ChineseSimplifiedOptions} [options={}] Configuration options.
   */
  constructor (options = {}) {
    super()
 ...
 * @param {ChineseSimplifiedOptions} [options] Conversion options.
...
export default function convertToWords (value, options = {}) {
  return new ChineseSimplified(options).convertToWords(value)
}
