 ...
 *
 * Extends AbstractLanguage directly as Hungarian uses a custom algorithm
 * rather than the greedy scale decomposition.
 */
export class Hungarian extends AbstractLanguage {
  negativeWord = 'mínusz'
  decimalSeparatorWord = 'egész'
  zeroWord = 'nulla'

  /** Map of values to Hungarian words. */
  words = new Map([
  ...
  /** Looks up the word for a given scale value. */
  wordForScale (value) {
