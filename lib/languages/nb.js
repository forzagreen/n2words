...
/**
 * Converts a number to Norwegian Bokmål cardinal (written) form.
 *
 * @param {number|string|bigint} value The number to convert.
 * @param {Object} [options] Conversion options.
 * @returns {string} The number expressed in Norwegian Bokmål words.
...
export default function convertToWords (value, options = {}) {
  return new NorwegianBokmal(options).convertToWords(value)
}
