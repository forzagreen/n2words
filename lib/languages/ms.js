...
/**
 * Converts a number to Malay cardinal (written) form.
 *
 * @param {number|string|bigint} value The number to convert.
 * @param {Object} [options={}] Configuration options.
 * @returns {string} The number expressed in Malay words.
 * @throws {TypeError} If value is an invalid type.
 * @throws {Error} If value is NaN or an invalid number string.
 * @example
 * convertToWords(42); // 'empat puluh dua'
 * convertToWords(1000); // 'seribu'
 * convertToWords(100000); // 'seratus ribu'
 */
