import { LongScaleLanguage } from '../classes/long-scale-language.js'
 ...
 * Supports:
 * - Long scale numbering (bilião = 10^12, not 10^9)
 ...
 */
export class Portuguese extends LongScaleLanguage {
  negativeWord = 'menos'
