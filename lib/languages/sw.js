...
/**
 * Converts a number to Swahili cardinal (written) form.
 *
 * @param {number|string|bigint} value The number to convert.
 * @param {Object} [options={}] Configuration options.
 * @returns {string} The number expressed in Swahili words.
 * @throws {TypeError} If value is an invalid type.
 * @throws {Error} If value is NaN or an invalid number string.
 * @example
 * convertToWords(42); // 'arobaini na mbili'
 * convertToWords(1000); // 'elfu moja'
 * convertToWords(100000); // 'laki moja'
 */
