 ...
 * - Support for very large numbers (up to decillions)
 */
export class RomanianNumberConverter extends AbstractLanguage {
  negativeWord = 'minus'
   ...
   * @returns {string[]} Array of words in written format
   */
    ...
    for (const x of chunks) {
      ...
      if (index === 0) {
        ...
        if (n2 === 1n) {
          ...
          const feminineUnits = this.options.feminine && index === 0
