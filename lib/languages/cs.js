...
export class Czech extends SlavicLanguage {
  ...
  /**
   * Cached whole number for decimal separator word selection.
  ...
  /**
   * Override toWords to cache whole number before decimal separator is accessed.
   */
  toWords (isNegative, wholeNumber, decimalPart) {
    this.#wholeNumber = wholeNumber
    return super.toWords(isNegative, wholeNumber, decimalPart)
  }
