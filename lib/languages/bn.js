...
/**
 * Converts a number to Bengali cardinal (written) form.
 *
 * @param {number|string|bigint} value The number to convert.
 * @param {BengaliOptions} [options={}] Configuration options.
 * @returns {string} The number expressed in Bengali words.
