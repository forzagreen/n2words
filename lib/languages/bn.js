 ...
 *
 * Implements Bangla number words using South Asian grouping patterns:
 * - Bangla script numerals (এক, দুই, তিন, চার...)
 * - Indian-style digit grouping: 3 digits on right, then 2-2 from right
 * - Traditional Bangla number scales (হাজার, লাখ, কোটি, আরব...)
