 ...
 */
export class Italian extends ScaleLanguage {
  negativeWord = 'meno'
  ...
  /**
   * Combines segment parts by concatenation with phonetic rules.
   * Italian joins words without spaces within segments.
   *
   * @protected
  ...
  /**
   * Converts integer to words with post-processing for accentuation.
   *
   ...
   * Handles the complex scale word and connector logic.
   *
   * @private
   * @param {bigint} integerPart The integer to convert.
