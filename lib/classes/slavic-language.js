 ...
 *
 * Extends ScaleLanguage with:
 * - Three-form pluralization (singular/few/many) via `pluralForms`
 ...
 */
export class SlavicLanguage extends ScaleLanguage {
  // ============================================================================
   ...
   *
   * Subclasses may override for language-specific variations.
   *
