...
/**
 * Segment-based scale language converter.
 *
 * A high-performance alternative to GreedyScaleLanguage that uses segment-based
 * decomposition (similar to SlavicLanguage) for better performance while still
 * supporting the flexible combine rules of Western European languages.
 *
 * Algorithm:
 ...
 * - `hundredWord`: String for "hundred"
 ...
 */
export class SegmentScaleLanguage extends AbstractLanguage {
  // ============================================================================
