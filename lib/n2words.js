...
const BengaliConverter = makeConverter(Bengali)
...
const FarsiConverter = makeConverter(Farsi)
const FilipinoConverter = makeConverter(Filipino)
const FrenchConverter = makeConverter(French)
const BelgianFrenchConverter = makeConverter(BelgianFrench)
...
const ChineseSimplifiedConverter = makeConverter(ChineseSimplified)
const ChineseTraditionalConverter = makeConverter(ChineseTraditional)
