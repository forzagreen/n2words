 ...
 * @param {*} [options.*] Any additional options are forwarded to the language-specific converter.
 *
...
function floatToCardinal (value, options = {}) {
  ...
  // Determine language (default to 'en'). Use string coercion for robustness.
  const lang = (options && options.lang) ? String(options.lang) : 'en'
