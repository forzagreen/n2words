...
/**
 * @typedef {Object} AmharicOptions
 * @property {('geez'|'latin')} [script='geez'] Output script - 'geez' for Ge'ez/Ethiopic, 'latin' for romanized
 */
...
const AmharicConverter = /** @type {(value: NumericValue, options?: AmharicOptions) => string} */ (makeConverter(Amharic))
