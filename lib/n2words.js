...
/**
 * Configuration object for number-to-words conversion.
 *
 ...
 *
 * Language-specific options may also be passed and are forwarded to the converter.
 * See individual language implementations for supported customization options
 * (e.g., `formal: true` for Chinese, `gender: 'feminine'` for Slavic languages).
 */
