...
import { Amharic } from './languages/am.js'
import { AmharicLatin } from './languages/am-Latn.js'
...
const AmharicConverter = /** @type {(value: NumericValue) => string} */ (makeConverter(Amharic))
const AmharicLatinConverter = /** @type {(value: NumericValue) => string} */ (makeConverter(AmharicLatin))
...
const FinnishConverter = /** @type {(value: NumericValue) => string} */ (makeConverter(Finnish))
...
const HausaConverter = /** @type {(value: NumericValue) => string} */ (makeConverter(Hausa))
