...
class KannadaLanguage extends SouthAsianLanguage {
  ...
  /**
   * Converts numbers below 100 using the belowHundred array.
   * @param {number} number - Number between 0 and 99
 ...
 * @param {import('../n2words.js').ConvertibleValue} value - The number to convert
 * @param {import('../n2words.js').CommonOptions} [options={}] - Conversion options
