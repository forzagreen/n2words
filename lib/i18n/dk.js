 ...
 *
 * Inherits from ScandinavianLanguage with Danish-specific extensions:
 ...
 * - Inherits merge() logic from ScandinavianLanguage with custom handling
 */
export class Danish extends ScandinavianLanguage {
  ordFlag
