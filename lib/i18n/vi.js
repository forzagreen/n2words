 ...
 */
export class VI extends AbstractLanguage {
  base = {
    0: 'không',
    1: 'một',
    2: 'hai',
  ...
  /**
   * Initializes the Vietnamese converter with language-specific options.
   *
   * @param {Object} options
   * @param {string} [options.negativeWord='âm'] Word for negative numbers (negative).
   * @param {string} [options.separatorWord='phẩy'] Word separating whole and decimal parts (comma).
   * @param {string} [options.zero='không'] Word for the digit 0 (zero).
   */
  constructor (options) {
    super(Object.assign({
      negativeWord: 'âm',
...
export default function floatToCardinal (value, options = {}) {
  return new VI(options).floatToCardinal(value)
}
