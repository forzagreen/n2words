...
export class Czech extends SlavicLanguage {
   ...
   *
   * @param {Object} [options={}] Configuration options (inherited from SlavicLanguage).
   */
  constructor (options = {}) {
    super(options)

    // Remove the inherited separatorWord property so our getter works
    delete this.separatorWord
  }
...
export default function floatToCardinal (value, options = {}) {
  return new Czech(options).floatToCardinal(value)
}
