 ...
 */
export class PT extends CardMatchLanguage {
  hundreds = {
    1: 'cento',
    2: 'duzentos',
    3: 'trezentos',
  ...
  postClean (words) {
    ...
    return words.replaceAll(PT.POSTCLEAN_REGEX, ' $1 ')
  }
 ...
 * @param {Object} [options] Conversion options (see PT class).
...
export default function floatToCardinal (value, options = {}) {
  return new PT(options).floatToCardinal(value)
}
