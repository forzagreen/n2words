 ...
 * - Phonetic contractions (removes duplicate vowels: "ventiotto" not "ventiotto")
 ...
 *
 * Architecture Note:
 * Unlike other BaseLanguage subclasses, Italian uses a custom algorithm
 ...
 * - Accentuation of final "tre" (ventitré, trentacinqueé - note: accent on compound tres)
 * - Exponent-based large number naming (milione, miliardo, trilione)
 * - Custom word construction for hundreds and thousands
 */
export class IT extends CardMatchLanguage {
  cardinalWords = [
