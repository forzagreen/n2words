 ...
 */
export class DE extends CardMatchLanguage {
  /**
  ...
  merge (currentPair, nextPair) {
    ...
    const currentNumber = Object.values(currentPair)[0] // BigInt from cards
    const nextNumber = Object.values(nextPair)[0] // BigInt from cards
