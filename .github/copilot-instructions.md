...
- **Core components:**
  ...
  - `lib/i18n/*.js`: per-language implementations (29 total). Most use `BaseLanguage` or `AbstractLanguage` from `lib/classes/`.
...
- **Files to inspect for examples:**
  ...
  - `lib/classes/base-language.js` and `lib/classes/abstract-language.js` — essential algorithms and optimizations.
